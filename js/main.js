...
endTime.setTime(endTime.getTime() + 30 * 1000);
...
var render = function(cxt) {
    ...
    // renderDigit(marginLeft + 15 * (littleArcR + 1), marginTop, parseInt(minutes / 10), cxt);
    // renderDigit(marginLeft + 35 * (littleArcR + 1), marginTop, parseInt(minutes % 10), cxt);
    // renderDigit(marginLeft + 55 * (littleArcR + 1), marginTop, 10, cxt);

    renderDigit(marginLeft + 35 * (littleArcR + 1), marginTop, parseInt(seconds / 10), cxt);
    renderDigit(marginLeft + 55 * (littleArcR + 1), marginTop, parseInt(seconds % 10), cxt);
...
var update = function() {
    ...
    if (nextSeconds != curSeconds) {
        ...
        if (parseInt(nextSeconds / 10) != parseInt(curSeconds / 10)) {
            addBall(marginLeft + 35 * (littleArcR + 1), marginTop, parseInt(curSeconds / 10))
        };
        if (parseInt(nextSeconds % 10) != parseInt(curSeconds % 10)) {
            addBall(marginLeft + 55 * (littleArcR + 1), marginTop, parseInt(curSeconds % 10))
        };
